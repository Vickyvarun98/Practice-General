...
public class TestScriptForOrgContact {
	...
	public static void main(String[] args) throws IOException {
		...
		String PHNO = row.getCell(3).getStringCellValue() + r.nextInt(1000);
		...
		String Actual_PHNO = driver.findElement(By.id("dtlview_Phone")).getText();
		...
		}if (Actual_PHNO.equals(PHNO)) {
			System.out.println("Contact.No is added");
		}else {
			System.out.println("Contact.No is not added");
		}
