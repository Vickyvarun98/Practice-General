...
public class ToAddProductToCartOnDemowebshop {
	...
	//		driver.findElement(By.linkText(""+Expected_Product_+""+i+"")).click();
			...
			WebElement Pro_Qty = driver.findElement(By.xpath("//div[@class='add-to-cart-panel']//following-sibling::input[@type='text']"));
			action.moveToElement(Pro_Qty).perform();
			Pro_Qty.clear();
			Pro_Qty.sendKeys(Quantity);
			driver.findElement(By.xpath("//div[@class='add-to-cart-panel']//following-sibling::input[@value='Add to cart']")).click();
